  ...
  render() {
    ...
    return (
      <div className="product-detail"> {
        ...
        } <h3><AiOutlineCalendar color="red" />
          <span style={{ fontSize: 14, marginLeft: 5 }} > {format(news.timeStamp, 'MMM DD YYYY')} </span></h3>
        <div className="content-area" dangerouslySetInnerHTML={{ __html: news.content }} style={{ width: '100%', overflow: 'hidden' }} />
      </div>
