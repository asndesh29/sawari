...
const addMainVarientStructure = (props, update) => {
  return [
    ...
    {
      element: 'radiogroup',
      placeHolder: 'Pass switch',
      value: 'passSwitch',
      radios: [{ element: 'radio', label: 'yes', value: 1 }, { element: 'radio', label: 'No', value: 0 }],
    },
    {
      element: 'input', placeHolder: 'Enter additional features...', value: 'additionalFeatures', type: 'text', label: 'Additional Features:',
    },
    {
      element: 'radiogroup',
      placeHolder: 'Passenger Footrest',
      value: 'passengerFootrest',
      radios: [{ element: 'radio', label: 'yes', value: 1 }, { element: 'radio', label: 'No', value: 0 }],
    },
    {
