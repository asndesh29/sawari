export default () => {
  return (
    [
      { 'New Cars': [
        { id: 10, name: 'Popular Cars' },
        { id: 11, name: 'Latest Cars' },
        { id: 12, name: 'Upcoming Cars' },
        { id: 13, name: 'Discount & Offers' },
        { id: 14, name: 'Compare Cars' },
        { id: 15, name: 'Showroom(Dealers)' },
        { id: 16, name: 'Service Center' },
      ],
      },
      {
        'Used Car': [
      ...
      {
        'New Bikes': [
          { id: 30, name: 'Popular Bikes' },
          { id: 31, name: 'Latest Bikes' },
