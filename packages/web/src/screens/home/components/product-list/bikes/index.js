    ...
    return (
      <Card elevation={0} className="home-product-list">
        ...
        <Tabs id="TabsExample" onChange={this.handleTabChange} selectedTabId={selectedTabId}>
          ...
          <Tab style={{ fontSize: 15 }} id="New" title="New" panel={<NewBikes {...this.props} />} />
          <Tab style={{ fontSize: 15 }} id="Popular" title="Popular" panel={<PopularBikes {...this.props} />} panelClassName="ember-panel" />
          <Tab style={{ fontSize: 15 }} id="Upcoming" title="Upcoming" panel={<PopularBikes {...this.props} />} />
        </Tabs>
      </Card>
    );
  }
