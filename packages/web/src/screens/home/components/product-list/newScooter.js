        ...
        <div className="product-list">
          <div style={{ width: '100%', textAlign: 'center', height: '100%' }}>
            <HorizontalScrollView
              // wheel
              data={main.initialData.vehicleModel ? main.initialData.vehicleModel.filter(m => m.varients.find(v => v.bodyType === 'Scooter')).filter(c => c.stypeId === 2 && c.category === category).map((obj) => ModelCard(obj, this.cardOnClickHandler)) : []}
