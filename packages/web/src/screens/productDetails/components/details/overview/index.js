...
export default (props) => {
  const { main, showEnquiryForm, currentProductDetails, variantId } = props;
  ...
  return (
    <div className="keyspecification-overview">
      <div className="detail-image-compare">
        ...
        <KeySpecification obj={currentProductDetails} showEnquiryForm={showEnquiryForm} variantId={variantId} />
      </div>
